...
class MarkdownHelper {
  ...
  static async convert(markdown) {
    try {
      // return MarkdownHelper.#dompurifier.sanitize(
      //   await marked.parse(markdown.replace(/^[\u200B\u200C\u200D\u200E\u200F\uFEFF]/, ''))
      // );

      /**
       * TODO
       * Re-enable domsanitization when I have more time to set up a working config for it
       * */
      return await marked.parse(markdown.replace(/^[\u200B\u200C\u200D\u200E\u200F\uFEFF]/, ''));
    } catch (e) {
